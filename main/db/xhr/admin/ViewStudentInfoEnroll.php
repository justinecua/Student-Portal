...
if (isset($_POST['userId'])) {
    ...
    $TranscriptOfRecordPath = $row["TransriptOfRecordPath"];
    $Cert_Of_CompletionPath = $row["Cert_Of_CompletionPath"];
    ...
    ?>
                <div><img class="Mg1UserStudPic" src="../../../../images/<?php echo $MG1UserStudPicSize ?>"></div>
                ...
                echo '<div class="BMainStudCont" ><div class="BStudInfoTitle">Email Address:</div><div class="StudContent"><span>' . $StudEmail . '</span></div></div>';
                ...
                if ($MG1UserIncLevel == "Grade 11" || $MG1UserIncLevel == "Grade 12") {
                    echo '<div class="DocStudEnroll"><a href="../../../../images/' . $MG1UserForm138_Size . '" target="_blank"><img src="../../../../images/' . $MG1UserForm138_Size . '"></a><span>Form 138</span></div>';
                    echo '<div class="DocStudEnroll"><a href="../../../../images/' . $MG1UserPSA_Size . '" target="_blank"><img src="../../../../images/' . $MG1UserPSA_Size . '"></a><span>PSA</span></div>';
                    echo '<div class="DocStudEnroll"><a href="../../../../images/' . $MG1UserGoodMoral_Size . '" target="_blank"><img src="../../../../images/' . $MG1UserGoodMoral_Size . '"></a><span>Good Moral Certificate</span></div>';
                    echo '<div class="DocStudEnroll"><a href="../../../../images/' . $Cert_Of_CompletionPath . '" target="_blank"><img src="../../../../images/' . $Cert_Of_CompletionPath . '"></a><span>Certificate of Completion</span></div>';
                } else if (empty($MG1UserForm138_Size)) {
                    echo '<div class="DocStudEnroll"><a href="../../../../images/' . $TranscriptOfRecordPath . '" target="_blank"><img src="../../../../images/' . $TranscriptOfRecordPath . '"></a><span>Transcript of Record</span></div>';
                    echo '<div class="DocStudEnroll"><a href="../../../../images/' . $MG1UserPSA_Size . '" target="_blank"><img src="../../../../images/' . $MG1UserPSA_Size . '"></a><span>PSA</span></div>';
                    echo '<div class="DocStudEnroll"><a href="../../../../images/' . $MG1UserGoodMoral_Size . '" target="_blank"><img src="../../../../images/' . $MG1UserGoodMoral_Size . '"></a><span>Good Moral Certificate</span></div>';
                } else {
                    echo '<div class="DocStudEnroll"><a href="../../../../images/' . $MG1UserForm138_Size . '" target="_blank"><img src="../../../../images/' . $MG1UserForm138_Size . '"></a><span>Form 138</span></div>';
