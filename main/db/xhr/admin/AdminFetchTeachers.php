    ...
    <table class="TableFetchTeachers">
        ...
        while ($TFgetrow = mysqli_fetch_assoc($TFdisplay)) {
            ...
            ?>
                ...
                <td>
                    <div class="TeacherProfile"><img src="../../images/<?php echo $ProfilePath ?>"></div>
                </td>
                <?php
                ...
                echo '<td><button class="DeleteSec" dataSYid="<?php ?>"><img src="../../images/trash-2 (3).svg" alt=""></button></td>';
                echo "</tr>";
        }
        ?>
